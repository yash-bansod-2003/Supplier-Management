          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                <Icons.cloud className="mb-1 h-7 w-7" />
              ...
              <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                ...
                <div className="flex w-12 justify-end text-xs">
                  {progress === "PENDING" ? (
                    ...
                    <Icons.fileWarning className="shrink-0 text-red-600 dark:text-red-400" />
                  ) : progress !== "COMPLETE" ? (
                    <div>{Math.round(progress)}%</div>
                  ) : (
                    <Icons.check className="shrink-0 text-green-600 dark:text-gray-400" />
                  )}
                </div>
              </div>
              {/* Progress Bar */}
